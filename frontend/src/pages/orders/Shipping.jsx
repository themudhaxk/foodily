...
const Shipping = () => {
  ...
  const [paymentMethod, setPaymentMethod] = useState("PaymentOnDelivery");
    ...
    <div className="container mx-auto mt-10">
      ...
      <div className="mt-[10rem] flex justify-around items-center flex-wrap">
        <form onSubmit={submitHandler} className="w-[40rem]">
          <h1 className="text-2xl text-black font-semibold mb-4">Shipping</h1>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="mt-2">
              <label className="inline-flex items-center">
                ...
                <span className="ml-2 text-black">Pay Now</span>
              </label>
            </div>
          </div>
